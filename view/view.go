...
func (v *ViewInfo) New(templateList ...string) *ViewInfo {
...
func (v *ViewInfo) Base(base string) *ViewInfo {
...
func (v *ViewInfo) Render(w http.ResponseWriter, r *http.Request) error {
